...
from Router.Contador import contador_router
from Router.Graph import graph_router
from pathlib import Path

route = Path.cwd()
app = FastAPI()
app.title = "Avántika Contador Dian"
app.version = "0.0.1"
...
app.add_middleware(
    ...
    CORSMiddleware,allow_origins=["https://contadordian.avantika.com.co"],  # Permitir todos los orígenes; para producción, especifica los orígenes permitidos.
